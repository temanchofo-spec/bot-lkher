...
const log = require("./SYSTEM/ColorLoger/log.js");
const { isHexColor, colors } = require("./SYSTEM/SystemLog/colors.js");
const Prism = require("./SYSTEM/SystemLog/prism.js");
...
function formatNumber(number) {
	const regionCode = global.NeroBot.config.language;
	if (isNaN(number))
...
function getPrefix(threadID) {
	...
	let prefix = global.NeroBot.config.prefix;
...
async function uploadImgbb(file /* stream or image url */) {
	...
	try {
		...
		// 		"likes": 0,
		// 		"description": null,
		// 		"original_filename": "Banner Project Nero Bot.png",
		// 		"is_animated": 0,
		// 		"is_360": 0,
		// 		"nsfw": 0,
		// 		"id_encoded": "D1yzzdr",
		// 		"size_formatted": "194.5 KB",
		// 		"filename": "Banner-Project-Nero-Bot.png",
		// 		"url": "https://i.ibb.co/wdXBBtc/Banner-Project-Nero-Bot.png",  // => this is url image
		...
		// 			"mime": "image/png",
		// 			"extension": "png",
		// 			"url": "https://i.ibb.co/wdXBBtc/Banner-Project-Nero-Bot.png",
		// 			"size": 194460
		// 		},
		// 		"thumb": {
		// 			"filename": "Banner-Project-Nero-Bot.png",
		...
		// 			"mime": "image/png",
		// 			"extension": "png",
		// 			"url": "https://i.ibb.co/D1yzzdr/Banner-Project-Nero-Bot.png"
		// 		},
		// 		"medium": {
		// 			"filename": "Banner-Project-Nero-Bot.png",
		// 			"name": "Banner-Project-Nero-Bot",
		// 			"mime": "image/png",
		// 			"extension": "png",
		// 			"url": "https://i.ibb.co/tHtQQRL/Banner-Project-Nero-Bot.png"
		// 		},
		// 		"display_url": "https://i.ibb.co/tHtQQRL/Banner-Project-Nero-Bot.png",
		// 		"display_width": 2560,
		// 		"display_height": 1440,
		...
		// 		"title": "Banner-Project-Nero-Bot",
		// 		"title_truncated": "Banner-Project-Nero-Bot",
		// 		"title_truncated_html": "Banner-Project-Nero-Bot",
		// 		"is_use_loader": false
		// 	},
		// 	"request": {
		// 		"type": "file",
...
const utils = {
	...
	getExtFromUrl,
	getPrefix,
	getText: require("./SYSTEM/longbot/getText.js"),
	getTime,
	getType,
	isHexColor,
	isNumber,
	jsonStringifyColor,
	loading: require("./SYSTEM/ColorLoger/loading.js"),
	log,
	logColor: require("./SYSTEM/ColorLoger/logColor.js"),
	message,
	randomString,
	randomNumber,
	removeHomeDir,
