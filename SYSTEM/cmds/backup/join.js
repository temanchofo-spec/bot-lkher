module.exports = {
  config: {
    ...
    role: 2,
    shortDescription: {
      ar: "قم بالإنضمام إلى مجموعة التي يوحد بها البوت",
    },
    longDescription: {
      ar: "يضيف هذا الأمر المستخدم إلى المجموعة التي يوجد بها البوت",
    },
    category: "المالك",
    guide: {
      ar: "لاستخدام هذا الأمر، اكتب ببساطة !إضمام <المجموعة>.",
    },
  },
